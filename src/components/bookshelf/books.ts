...
export const BOOKS: Book[] = [
  ...
  { id: "donate", title: "Donate", spine: "var(--spine-terracotta)", textColor: "var(--spine-cream)", height: 170, width: 34, toc: ["A note from the maker", "Google Play release", "Apple developer license", "Hosting & sync", "Community poll"] },
